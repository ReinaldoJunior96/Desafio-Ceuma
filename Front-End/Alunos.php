    ...
    <form action="cURL/cURLAluno/POST_Aluno.php" method="POST">
        ...
        <div class="form-row">
            <div class="form-group formcrud col-sm-12">
                ...
                <input type="text" name="endereco" class="form-control" id="inputAddress"
                       placeholder="Av Jerônimo de Albuquerque, nº 0">
            </div>
        </div>
        <div class="form-row">
        ...
        <div class="form-row ">
            ...
            <div class="form-group formcrud col-md-6">
                ...
                <input type="text" name="telefone" maxlength="50" class="form-control" id="inputCity"
                       placeholder="(00)984758486" required="">
            </div>
        </div>
