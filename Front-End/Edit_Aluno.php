        ...
        <form action="cURL/cURLAluno/PUT_Aluno.php" method="POST">
          ...
          <div class="form-row">
            <div class="form-group formcrud col-sm-12">
                ...
                <input type="text" name="endereco" value="<?php echo $aluno->endereco ?>" class="form-control" id="inputAddress" placeholder="Av Jerônimo de Albuquerque, nº 0">
              </div>
          </div>
          <div class="form-row">
              <div class="form-group formcrud col-sm-8">
                <label for="inputAddress2">CEP</label>
                <input type="text" name="CEP" value="<?php echo $aluno->CEP ?>" class="form-control" id="inputAddress2">
              </div>
